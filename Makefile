...
#    Updated: 2022/07/08 20:30:52 by lomasson         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ALL = $(LIBFT) $(PIPEX) \
	arbre_binaire check_condition ft_split_commande ft_split_argument main verif_commande builtins exec_cmd builtins_part exec_utils
SUBFOLDER = 
